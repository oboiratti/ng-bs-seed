...
export class ReportComponent implements OnInit, OnDestroy {
    ...
    this.reports = [
      {
        ...
        filters: [
          ...
          },
          {
            ...
            type: 'select',
            model: 'districtId',
            lookupUrl: 'district/selectget',
            lookupStore: 'districts',
            hasChild: true,
            hasParent: true,
            parentModelName: 'regionId',
          },
          { label: 'Location', type: 'text', model: 'location' },
          {
            ...
            type: 'select',
            model: 'commodityId',
            lookupUrl: 'commodity/selectget',
            lookupStore: 'commodities',
          },
          {
            label: 'Program',
            type: 'select',
            model: 'programId',
            lookupUrl: 'program/selectget',
            lookupStore: 'programs',
          },
          {
            label: 'Type',
            type: 'select',
            model: 'typeId',
            lookupUrl: 'subscribertype/selectget',
            lookupStore: 'subscriberTypes',
          },
        ],
  ...
  getReportData(params: any) {
    ...
    this.params = params
    this.reportService
      .getReport(this.selectedReport.query, params)
      .pipe(
